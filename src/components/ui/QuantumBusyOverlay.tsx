  ...
  return (
    <div className={`quantum-busy quantum-busy-${tone}`} role="status" aria-live="polite">
      <div className="quantum-busy-card">
        ...
        <div className="mt-5 flex items-center justify-center gap-2 font-display text-2xl text-quantum-ink">
          <LoaderCircle className="h-5 w-5 animate-spin" />
          {title}
        </div>
        <div className="mt-2 max-w-sm text-center font-mono text-xs text-quantum-ink/50">
          {subtitle}
        </div>
      </div>
    </div>
